...
// const CHANNEL_KEY = "Agent-Assistant"; // <— fixed to Agent-Assistant

// export default function AgentAssistHistory() {
...
//   return (
//     <>
//       {/* Filters (channel fixed to Agent-Assistant) */}
...
//   .filter(msg => {
//     // Skip completely empty or internal placeholder messages
//     if (!msg.content || msg.content === "[]" || 
//         (typeof msg.content === "string" && msg.content.trim() === "")) {
//       return false;
//     }
//     // Skip tool calls unless it's a package list
//     if (msg.role === "tool" && msg.type !== "list") return false;
//     return true;
//   })
//   .sort((a, b) => {
//     // PRIMARY: Use sequence_id for correct order (most reliable)
//     const seqA = parseInt(a.sequence_id || "0", 10);
//     const seqB = parseInt(b.sequence_id || "0", 10);
//     if (seqA !== seqB) return seqA - seqB;

//     // FALLBACK: Use chat_time if sequence_id missing or equal
//     return new Date(a.chat_time).getTime() - new Date(b.chat_time).getTime();
//   })
//   .map((msg, index) => {
//     let displayContent = "";
//     let packages = [];
...
//           // Handle rare case where content is direct array
//           packages = parsed;
...
//     // Deduplicate assistant messages with same sequence_id (keep latest modified)
//     const prevMsg = index > 0 ? selectedConversation.conversation[index - 1] : null;
//     if (isAssistant && prevMsg && prevMsg.sequence_id === msg.sequence_id && prevMsg.role === "assistant") {
//       return null; // Skip older version of same assistant response
//     }
...
//           backgroundColor: isAgent ? "#e0f7fa" : (isAssistant ? "#f1f5f9" : undefined),
//           alignSelf: isUser ? "flex-end" : "flex-start",
//         }}
//       >
//         {isAgent && (
//           <div style={{ fontSize: "0.7em", fontWeight: "bold", color: "#006064", marginBottom: "4px" }}>
//             Agent
//           </div>
//         )}
//         {isAssistant && (
//           <div style={{ fontSize: "0.7em", fontWeight: "bold", color: "#555", marginBottom: "4px" }}>
//             Tacy (AI)
//           </div>
//         )}
...
//                   <h4 style={{ margin: "0 0 8px 0" }}>{pkg.title || "Untitled Package"}</h4>
//                   <p style={{ margin: "4px 0" }}>{pkg.days || "N/A"}</p>
//                   <p style={{ margin: "4px 0", fontWeight: "bold" }}>{pkg.price || "Price on request"}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//         >
//           {msg.chat_time
//             ? new Date(msg.chat_time).toLocaleTimeString("en-IN", {
//                 timeZone: "Asia/Kolkata",
//                 hour: "2-digit",
//                 minute: "2-digit",
//                 second: "2-digit",
