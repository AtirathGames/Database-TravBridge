...
function SOTCVoiceBotStats() {
  ...
  const fetchStats = async () => {
    ...
    setError("");
    try {
      const response = await axios.post(`${BASE_URL}/v1/voicebot_conversation_stats`, {
        from_date: fromDate,
        to_date: toDate,
  ...
  const downloadExcel = async () => {
    try {
      ...
      if (resData?.excel_base64) {
        ...
        link.download = resData.filename || "sotc_voicebot_conversation_stats.xlsx";
  ...
  // Empty Conversations % = Empty / Total
  ...
  return (
    <div className="sotc-cb-container">
      ...
      <div className="sotc-cb-header-row">
        ...
        <div className="sotc-cb-header">Conversation Insights — VoiceBot (SOTC)</div>
            ...
            <div className="sotc-cb-charts-controls">
              {tab === "funnels" && (
                <div className="sotc-cb-pills">
                  <div
                    className={`sotc-cb-pill ${funnelView === "stacked" ? "active" : ""}`}
                    onClick={() => setFunnelView("stacked")}
                  >
                    Stacked
                  </div>
                  <div
                    className={`sotc-cb-pill ${funnelView === "bars" ? "active" : ""}`}
              ...
              <div className="sotc-cb-pills">
                ...
                <div
                  className={`sotc-cb-pill ${tab === "split" ? "active" : ""}`}
          ...
          {loading ? (
            ...
            <>
              ...
              {tab === "funnels" && (
                <>
                  {funnelView === "stacked" && (
                    <div className="sotc-cb-funnel-grid">
                      <StepStackedFunnel
                      ...
                      <StepStackedFunnel
                        ...
                        stages={funnelUTM}
                      />
                      <div className="sotc-cb-funnel-full">
                        <StepStackedFunnel
...
export default SOTCVoiceBotStats;
